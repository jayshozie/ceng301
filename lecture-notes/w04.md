...
int main()
{
    ...
    list.add(15, 1);
    list.print(); // Expected output: 10 15 20 30
    std::cout << "Element at index 2: " << list.get(2) << std::endl; // Expected output: 20
    list.set(25, 2);
    list.print(); // Expected output: 10 15 25 30
    list.remove(1);
    list.print(); // Expected output: 10 25 30
    std::cout << "Size of the list: " << list.size() << std::endl; // Expected output: 3
}
```
